...
";
    ...
    #[test]
    fn test_moves_stack() {
        Day5::from_input(INPUT.to_string());
    }
    #[test]
    fn test_part1() {
        assert_eq!(Day5::from_input(INPUT.to_string()).part1(), "CMZ")
    }

    #[test]
    fn test_part2() {
        assert_eq!(Day5::from_input(INPUT.to_string()).part2(), "MCD")
    }
}
